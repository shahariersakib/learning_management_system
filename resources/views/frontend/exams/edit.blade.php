                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="examtitle" class="form-control" value="{{ $exams->examtitle }}" placeholder="Exam Title">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="examcode">Exam Code <span class="text-danger">*</span> </label>
                                            <input type="text" class="form-control" name="examcode" value="{{ $exams->examcode }}" placeholder="Exam Code">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="examdate">Exam date <span class="text-danger">*</span> </label>
                                            <input type="date" class="form-control" name="examdate" value="{{ $exams->examdate }}" placeholder="Exam Date">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="examtime">Exam Time <span class="text-danger">*</span> </label>
                                            <input type="time" class="form-control" name="examtime" value="{{ $exams->examtime }}" placeholder="Exam Time">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="marks">Exam Marks <span class="text-danger">*</span> </label>
                                            <input type="number" class="form-control" name="marks" value="{{ $exams->marks }}" placeholder="Exam Marks">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="totaltime">Total Time in Minutes <span class="text-danger">*</span> </label>
                                            <input type="number" class="form-control" name="totaltime" value="{{ $exams->totaltime }}" placeholder="Total Time in Minutes">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
